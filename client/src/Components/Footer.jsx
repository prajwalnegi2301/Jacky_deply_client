...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-t from-purple-600 via-purple-600 to-purple-600 ">
      <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
        <div className="mb-4 md:mb-0">
          <h2 className="text-lg text-white font-bold">Jacky</h2>
          <p className="text-white">© 2024 Jacky. All rights reserved.</p>
        </div>
